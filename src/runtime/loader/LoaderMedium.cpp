...
static std::shared_ptr<Medium> medium_heterogeneous(const std::string& name, const std::shared_ptr<SceneObject>& medium, LoaderContext&)
{
    return std::make_shared<HeterogeneousMedium>(name, medium);
}
